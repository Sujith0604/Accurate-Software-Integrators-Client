import { SiFacebook, SiGoogle, SiLinkedin, SiSpotify } from "react-icons/si";
            ...
            <div className="grid lg:grid-cols-2 items-start gap-12">
              <form className="space-y-3 text-white">
                <input
                  type="text"
                  placeholder="Name"
                  className="w-full  rounded py-3 px-6 text-sm focus:bg-transparent focus:outline-blue-600"
                />
                <input
                  type="email"
                  placeholder="Email"
                ...
                <textarea
                  placeholder="Message"
                  rows="6"
                  className="w-full  rounded px-6 text-sm pt-3 focus:bg-transparent focus:outline-blue-600"
                ></textarea>
                <button
                  type="button"
              ...
              <div className="grid sm:grid-cols-2  gap-12">
                ...
                <div className="flex items-start ">
                  ...
                  <div className="ml-6">
                    <h4 className="text-white text-base font-bold">Call us</h4>
                ...
                <div className="flex items-start ">
                  ...
                  <div className="ml-6">
                    <h4 className="text-white text-base font-bold">Fax</h4>
